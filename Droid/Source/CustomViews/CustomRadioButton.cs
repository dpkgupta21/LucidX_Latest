...
namespace LucidX.Droid.Source.CustomViews
{
    ...
    public class CustomRadioButton : RadioButton
    {
        ...
        public CustomRadioButton(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            this.context = context;
            Initialize();
        }
        public CustomRadioButton(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            this.context = context;
            Initialize();
        }
